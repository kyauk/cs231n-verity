...
to outputs/waymo/judge_scored.json, which the Judge UI hot-reloads.
    ...
    set -a && . ./.env && set +a
    .venv/bin/python verity_judge.py --limit 30      # quick look
    .venv/bin/python verity_judge.py --limit 0       # all segments
"""
...
from verity_run import LocalCosmosVideoClient, list_segments, annotate_segment
