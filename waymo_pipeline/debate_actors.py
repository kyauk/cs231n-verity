...
from waymo_pipeline.actor_tools import DebateContext
from waymo_pipeline.debate_scoring import (
...
from waymo_pipeline.models.handoff_contracts import DebateInputRecord, DebateOutputRecord
from waymo_pipeline.react_loop import ActorContribution, run_actor
...
def _fallback_risk_output(
    ...
    from waymo_pipeline.actor_tools import safety_taxonomy_lookup
